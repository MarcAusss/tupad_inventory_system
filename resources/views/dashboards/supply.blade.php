<x-po_dashboard_layout>
    ...
    <div class="grid grid-col md:grid-cols-9 grid-rows-2 md:grid-rows-2 gap-2 md:gap-2 m-4">
      <div class="col-start-1 h-82.75  row-start-1 col-span-4 md:col-start-1 md:row-start-1 md:col-span-4 md:row-span-1 bg-gray-300 rounded-md p-10">Supply Account</div>
